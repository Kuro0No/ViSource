...
from .views import ChangePasswordView, CustomUserCreate, BlacklistTokenUpdateView, ProfileModels, UpdateNameProfileView,UpdateAvatarProfileView, getYourVideo, savedVideo
